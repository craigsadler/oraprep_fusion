...
#unless node[:oraprep_fusion][:user][:pw_set]
#  ora_edb_item = Chef::EncryptedDataBagItem.load(node[:oraprep_fusion][:user][:edb], node[:oraprep_fusion][:user][:edb_item])
...
#    block do
#      node.set[:oraprep_fusion][:user][:pw_set] = true
#    end
#    action :create
#  end
#end
